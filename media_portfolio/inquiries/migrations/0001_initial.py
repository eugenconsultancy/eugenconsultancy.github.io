...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='inquiry',
            index=models.Index(fields=['status', '-created_at'], name='inquiries_i_status_152cc6_idx'),
        ),
        migrations.AddIndex(
            model_name='inquiry',
            index=models.Index(fields=['inquiry_type', 'status'], name='inquiries_i_inquiry_a4e2f7_idx'),
        ),
    ]
